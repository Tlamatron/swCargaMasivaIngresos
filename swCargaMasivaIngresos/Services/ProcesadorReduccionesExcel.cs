...
namespace swCargaMasivaIngresos.Services
{
	public class ProcesadorReduccionesExcel : IProcesadorFormato
	{
		...
		public ResultadoProceso Procesar(string rutaArchivo, ParametrosCarga param)
		{
			...
			LogService.WriteLogAsync(AppName, "INFO", param.UsuarioLogin, "ProcesadorReduccionesExcel", $"Inicia lectura de archivo Excel de Descuentos. Folio: {param.FolioCarga}");
